...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-rvm``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-rvm )`` to your list of
   plugins
...
1. Add ``antibody bundle luismayta/zsh-rvm`` to your
   ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
   run ``antibody bundle luismayta/zsh-rvm`` in a
   running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-rvm.svg
   :target: https://travis-ci.org/luismayta/zsh-rvm
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-rvm.svg
   :target: https://github.com/luismayta/zsh-rvm/issues
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/hadenlabs/zsh-rvm/readme
   :target: https://github.com/hadenlabs/zsh-rvm
